...
@RestController
@RequestMapping("/api/cvcorp-kafka")
public class CvcorpKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CvcorpKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CvcorpKafkaResource(KafkaProperties kafkaProperties) {
